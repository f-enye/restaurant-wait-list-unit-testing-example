...
def _get_added_to_waitlist_message(party: Party) -> str:
    return (
        ...
        "We expect to have your table prepared in "
        f"about {party.quoted_time_in_minutes} minutes."
    )
...
def _get_waitlist_delayed_message(party: Party) -> str:
    return (
        "Apologies, it is taking longer than expected to finish preparing "
        "your table. Please see the host if you have any questions."
    )
